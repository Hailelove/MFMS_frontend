...
const AdminLayout = () => {
  ...
  const NAV_ITEMS = [
    ...
    { to: "/admin/campuses", icon: "🏢", label: t("nav.Campus Register") },
    { to: "/admin/register", icon: "👤", label: t("nav.Register Member") },
    { to: "/admin/Member", icon: "👥", label: t("nav.Manage Member") },
    { to: "/admin/savings", icon: "🏦", label: t("nav.Manage Savings") },
    { to: "/admin/loans", icon: "💳", label: t("nav.Manage Loans") },

    { to: "/admin/payroll", icon: "💰", label: t("nav.Payroll Check") },
    { to: "/admin/ledger", icon: "🧾", label: t("nav.Ledger") },
    // { to: "/admin/attendance", icon: "📋", label: "Attendance" },
    { to: "/admin/reports", icon: "📊", label: t("nav.Reports") },
    { to: "/admin/system_config", icon: "⚙️", label: t("nav.System Config") },
  ];
